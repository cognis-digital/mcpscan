"""Native cognis-connect emit for mcpscan — forward findings to any platform.

Maps mcpscan's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    mcpscan ... --format json | mcpscan-emit --to stix
    mcpscan-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
