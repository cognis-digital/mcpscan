"""Native cognis-connect emit for mcpharden — forward findings to any platform.

Maps mcpharden's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    mcpharden ... --format json | mcpharden-emit --to stix
    mcpharden-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
